...
public final class JhipetclinicPage<T> {
  ...
  private JhipetclinicPage(JhipetclinicPageBuilder<T> builder) {
    content = JhipetclinicCollections.immutable(builder.content);
  ...
  public static <T> JhipetclinicPage<T> singlePage(List<T> content) {
    return builder(content).build();
  }

  public static <T> JhipetclinicPageBuilder<T> builder(List<T> content) {
    return new JhipetclinicPageBuilder<>(content);
  }

  public static <T> JhipetclinicPage<T> of(List<T> elements, JhipetclinicPageable pagination) {
  ...
  public <R> JhipetclinicPage<R> map(Function<T, R> mapper) {
  ...
  public static final class JhipetclinicPageBuilder<T> {
    ...
    private JhipetclinicPageBuilder(List<T> content) {
      this.content = content;
    }

    public JhipetclinicPageBuilder<T> pageSize(int pageSize) {
      this.pageSize = pageSize;

      return this;
    }

    public JhipetclinicPageBuilder<T> currentPage(int currentPage) {
      this.currentPage = currentPage;

      return this;
    }

    public JhipetclinicPageBuilder<T> totalElementsCount(long totalElementsCount) {
      this.totalElementsCount = totalElementsCount;

      return this;
    }

    public JhipetclinicPage<T> build() {
      return new JhipetclinicPage<>(this);
    }
  }
}
